  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="flex h-9 w-9 items-center justify-center rounded-full border border-brand-primary/30 bg-brand-primary/10 text-sm font-semibold text-brand-primary">
          {initial}
        </button>
      </DropdownMenuTrigger>
